...
class SummarizePageTool(Tool):
    ...
    parameters = {"url": {"type": "string", "description": "URL to summarize", "required": True}, "focus": {"type": "string", "description": "Focus topic", "default": ""}, "max_length": {"type": "string", "description": "brief/medium/detailed", "default": "medium"}}
...
def _extract_points(text: str) -> list[str]:
    ...
    return [l for l in lines if l.startswith("- ") or l.startswith("* ")][:5] or [lines[0]] if lines else []
